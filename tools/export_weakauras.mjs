...
// ----------------------------------------------------------------------
const templates = [
  { name: 'Mode badge',       data: modeBadge,      desc: 'Big colour-coded mode + target line. Hides outside arena.' },
  { name: 'Burst gate',       data: burstGate,      desc: 'Pulsing icon when IsBurstAllowed() is true on KILL mode.' },
  { name: 'Defensive alert',  data: defensiveAlert, desc: 'Top-centred DEFEND callout with the reason.' },
  { name: 'Callout stream',   data: calloutList,    desc: 'Bottom-left stream of the top 3 callouts.' },
  { name: 'Comp readout',     data: compReadout,    desc: 'Compact comp label + spec-confirmed / class-guessed badge.' },
];
