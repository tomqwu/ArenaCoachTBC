...
| `/acc test hud` | visual HUD demo — paints the compact action toast (arcade cue, mode label, target stats, assignments, nameplate, audio cues, optional thin edge cue) | 视觉 HUD 演示——紧凑行动提示（街机提示、模式、信息行、分工、铭牌、音效、可选细边缘提示） |
