...
SIM:Register("real-arena", {
    ...
    events = {
        ...
        { t = 14.0, type = "friendly_debuff", by = 2, unit = "party2", spell = S.POLYMORPH_SHEEP, label = "Our druid is polymorphed" },
        { t = 18.0, type = "cast", by = 1, spell = S.KIDNEY_SHOT, noEvaluate = true, label = "Rogue kidneys the healer" },
        { t = 19.0, type = "damage", by = 1, on = "party2", hits = 3, pct = 54, label = "Three burst hits land on our healer" },
