...
ns.locales.zhCN = {
    ...
    UI_MODULE_TEAM       = "队伍",
    UI_MODULE_BURST      = "爆发",
    UI_MODULE_UTILITY    = "功能",
    UI_MODULE_WAITING    = "等待",
    UI_ARCADE_READY      = "准备",
    UI_ARCADE_ATTACK     = "进攻",
    UI_ARCADE_SWITCH     = "转火",
    UI_ARCADE_DANGER     = "危险",
    ...
    ACTION_DPS_KILL         = "打击杀目标",
    ACTION_DPS_PEEL         = "保护队友",
    ACTION_DPS_RESET        = "断战 / 卡视角 / 喝水",
    ACTION_HEALER_RESET     = "抬血 / 喝水",
    ACTION_WARRIOR_KILL     = "致死 / 断筋",
    ACTION_ROGUE_OPEN       = "闷棍副目标",
    ACTION_ROGUE_KILL       = "肾击 / 打断",
    ACTION_HUNTER_TRAP      = "冰冻治疗 / 压上",
    ACTION_MAGE_CC          = "反制 / 羊副目标",
    ACTION_WARLOCK_CC       = "恐惧副目标",
    ...
    ACTION_PRIEST_DAMAGE    = "沉默 / 输出",
    ACTION_PRIEST_DEFEND    = "痛苦压制 / 驱散",
    ACTION_DRUID_CC         = "飓风副目标",
    ACTION_DRUID_HEAL_CC    = "持续治疗 / 飓风",
    ACTION_DRUID_DEFEND     = "持续治疗 / 飓风保护",
