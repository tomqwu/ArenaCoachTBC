...
ns.locales.zhCN = {
    ...
    HELP_FACTS     = "/acc facts on|off [legend on|off] - 敌方饰品/保命技/打断CD与递减显示",
    FACTS_KICK_LABEL = "打断",
    HELP_LEARNED   = "/acc learned        - 显示当前对手已学习到的贝叶斯倾向",
    LEARNED_HEADER = "本场学习到的对手倾向：",
    LEARNED_NONE   = "尚无对手画像（每项倾向需 ~5 次观察）。",
    FACTS_DEF_LABEL  = "保命",
    FACTS_COL_NAME    = "敌人",
    FACTS_COL_TRINKET = "饰品",
    FACTS_COL_DEF     = "保命技",
    FACTS_COL_INT     = "打断",
    FACTS_COL_DR      = "递减",
    FACTS_LEGEND      = "S=眩晕  F=恐惧  D=致盲  P=变形/闷棍  R=定身  C=飓风  ·  1/2=半时长  1/4=四分之一  IMM=免疫",
    ...
    UI_BURST_READY       = "可爆发",
    UI_ACTIONS_HEADER    = "你的行动",
    UI_SELF_TAG          = "你",
    UI_MODULE_FOCUS      = "焦点",
    UI_MODULE_CUES       = "提示",
    UI_MODULE_STRATEGY   = "策略",
    UI_MODULE_PLAN       = "计划",
    UI_MODULE_COMP       = "阵容",
    UI_MODULE_PROFILE    = "习惯",
    UI_MODULE_AGGRESSION = "激进",
    UI_MODULE_TARGET     = "目标",
    UI_MODULE_SWAP       = "换火",
    UI_MODULE_TEAM       = "队伍",
    UI_MODULE_BURST      = "爆发",
