...
ns.locales.enUS = {
    ...
    HELP_FACTS    = "/acc facts on|off [legend on|off] - per-enemy trinket/defensive/interrupt CDs + DR",
    FACTS_KICK_LABEL = "INT",  -- generic interrupt fallback: a downed Counterspell must not read "KICK"
    HELP_LEARNED  = "/acc learned        - show Bayesian tendencies learned about the current opponent",
    LEARNED_HEADER = "Learned this match:",
    LEARNED_NONE  = "No opponent profile yet (need ~5 observations per tendency).",
    FACTS_DEF_LABEL  = "DEF",
    FACTS_COL_NAME    = "Name",
    FACTS_COL_TRINKET = "Trinket",
    FACTS_COL_DEF     = "Defensive",
    FACTS_COL_INT     = "Interrupt",
    FACTS_COL_DR      = "DR",
    FACTS_LEGEND      = "S=Stun  F=Fear  D=Disorient  P=Incap  R=Root  C=Cyclone  ·  1/2=half  1/4=quarter  IMM=immune",
    ...
    UI_ACTIONS_HEADER    = "Your next move",
    UI_SELF_TAG          = "YOU",
    UI_MODULE_FOCUS      = "Focus",
    UI_MODULE_CUES       = "Cues",
    UI_MODULE_STRATEGY   = "Strategy",
    UI_MODULE_PLAN       = "Plan",
    UI_MODULE_COMP       = "Comp",
    UI_MODULE_PROFILE    = "Profile",
    UI_MODULE_AGGRESSION = "Aggro",
