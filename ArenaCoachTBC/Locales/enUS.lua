...
ns.locales.enUS = {
    ...
    CALL_TREMOR_DOWN     = "Tremor down - shaman refresh",
    ...
    UI_MODULE_SWAP       = "Swap",
    UI_MODULE_TEAM       = "Team",
    UI_MODULE_BURST      = "Burst",
    UI_MODULE_UTILITY    = "Utility",
    UI_MODULE_WAITING    = "waiting",
    ...
    ACTION_DPS_KILL         = "hit kill target",
    ACTION_DPS_PEEL         = "peel for teammate",
    ACTION_DPS_RESET        = "reset / line / drink",
    ACTION_HEALER_RESET     = "top team / drink",
    ACTION_WARRIOR_KILL     = "MS / Hamstring",
    ACTION_ROGUE_OPEN       = "Sap off-target",
    ACTION_ROGUE_KILL       = "Kidney / kick",
    ACTION_HUNTER_TRAP      = "trap healer / push",
    ACTION_MAGE_CC          = "CS / sheep off-target",
    ACTION_WARLOCK_CC       = "Fear off-target",
    ACTION_SHAMAN_PURGE     = "Purge / shock",
    ACTION_SHAMAN_BLOODLUST = "Bloodlust / purge",
    ...
    ACTION_PRIEST_OFFENSE   = "Dispel / Mana Burn",
    ACTION_PRIEST_DAMAGE    = "Silence / damage",
    ACTION_PRIEST_DEFEND    = "Pain Supp / dispel",
    ACTION_DRUID_CC         = "Cyclone off-target",
    ACTION_DRUID_HEAL_CC    = "HoTs / Cyclone",
    ACTION_DRUID_DEFEND     = "HoTs / Cyclone peel",
