...
H.it(g, "InitDB applies all defaults", function()
    ...
    H.assertEq(db.frame.displayMode, "alert")
    H.assertEq(db.alertFrame.point, "CENTER")
...
H.it(g, "/acc visual toggles update persisted settings", function()
    ...
    SlashCmdList["ARENACOACH"]("hud board")
    H.assertEq(_G.ArenaCoachTBCDB.frame.displayMode, "board")
    SlashCmdList["ARENACOACH"]("hud both")
    H.assertEq(_G.ArenaCoachTBCDB.frame.displayMode, "both")
    SlashCmdList["ARENACOACH"]("hud alert")
    H.assertEq(_G.ArenaCoachTBCDB.frame.displayMode, "alert")
