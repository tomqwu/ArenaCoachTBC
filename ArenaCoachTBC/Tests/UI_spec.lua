...
H.it(g, "CreateFrame builds prototype-A module set", function()
    ...
    H.assertTrue((f._width or 999) <= 520, "main board width should stay compact")
    H.assertTrue((f._height or 999) <= 190, "main board height should stay compact")
    ...
    H.assertEq(f.leftPanel._width, 121)
    H.assertEq(f.centerPanel._width, 241)
    H.assertEq(f.rightPanel._width, 106)
    H.assertEq(f.assignPanel._width, 241)
    H.assertEq(f.leftPanel._height, 140)
    H.assertEq(f.centerPanel._height, 80)
    H.assertEq(f.rightPanel._height, 140)
    ...
    H.assertEq(f._minResize[1], 430)
    H.assertEq(f._minResize[2], 176)
    H.assertEq(f._maxResize[1], 760)
    H.assertEq(f._maxResize[2], 320)
    H.assertEq(f.centerPanel._point[5], -32)
    H.assertEq(f.centerPanel._point[4], 137)
    H.assertEq(f.rightPanel._point[4], 386)
